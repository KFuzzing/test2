...
#define FOREIGN_SYNCS_MAX 32U
  ...
  u32 max_local_bitmap_size;
  u32 min_local_bitmap_size;
  double max_bitmap_incre;
  double min_bitmap_incre;
  double max_weighted_cov;
  double min_weighted_cov;

  struct queue_entry *target_q;
  u32 target_q_entry;
  u32 epoch_cnt;
